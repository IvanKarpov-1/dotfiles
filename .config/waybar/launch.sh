...
if [ -f ~/.config/mimic/settings/waybar-theme.sh ]; then
    themestyle=$(cat ~/.config/mimic/settings/waybar-theme.sh)
else
    touch ~/.config/mimic/settings/waybar-theme.sh
    echo "$default_theme" >~/.config/mimic/settings/waybar-theme.sh
...
if [ ! -f $HOME/.config/mimic/settings/waybar-disabled ]; then

...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="$HOME/.config/mimic/listeners/gtk-theme-switcher.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/mimic/listeners/another-listener.sh"
